<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tagsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="种子" align="center" prop="torrentId" />
...
<script>
import { listTags, getTags, delTags, addTags, updateTags, exportTags } from "@/api/galaxy/tags";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除种子标签编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有种子标签数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
