...
public class BitTorrentTagsController extends BaseController
{
    @Autowired
    private IBitTorrentTagsService glxTorrentTagsService;
    ...
    @GetMapping("/list")
    public TableDataInfo list(BitTorrentTags bitTorrentTags)
    {
        startPage();
        List<BitTorrentTags> list = glxTorrentTagsService.selectGlxTorrentTagsList(bitTorrentTags);
    ...
    @GetMapping("/export")
    public AjaxResult export(BitTorrentTags bitTorrentTags)
    {
        List<BitTorrentTags> list = glxTorrentTagsService.selectGlxTorrentTagsList(bitTorrentTags);
        ExcelUtil<BitTorrentTags> util = new ExcelUtil<BitTorrentTags>(BitTorrentTags.class);
    ...
    @PostMapping
    public AjaxResult add(@RequestBody BitTorrentTags bitTorrentTags)
    {
        return toAjax(glxTorrentTagsService.insertGlxTorrentTags(bitTorrentTags));
    }
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody BitTorrentTags bitTorrentTags)
    {
        return toAjax(glxTorrentTagsService.updateGlxTorrentTags(bitTorrentTags));
    }
